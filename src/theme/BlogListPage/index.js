          ...
          <div className="bloghome__intro">
            <animated.div style={animatedTexts[0]} className="hero_text">
              ...
              <span className="intro__name">
                <Translate description="my name">资源挖掘博客</Translate>
              </span>
            </animated.div>
            <animated.p style={animatedTexts[1]}>
              ...
              >
                {`在这里，有{blogs}以及UP主的{ideas}。致力于帮助你以最直观、最快速的方式找到资源，并希望我的个人经历对你有所启发。`}
              </Translate>
            </animated.p>
            {currentLocale === "zh-CN" && (
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      ...
      <a href="https://blog.csdn.net/this_zq?spm=1000.2115.3001.5343">
        <CSDNIcon />
      </a>
